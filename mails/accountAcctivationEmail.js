...
export const accoutActivationEmail = async (options) => {
  try {
      ...
      html: `
          <!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            * {
            ...
            <body class="clean-body u_body" style="margin: 0;padding: 50px;-webkit-text-size-adjust: 100%;background-color: #F7F8F9;color: #000000">
            ...
            <tr>
                ...
                <img align="center" border="0" src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/Facebook_Messenger_logo_2018.svg/1024px-Facebook_Messenger_logo_2018.svg.png" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 31%;max-width: 150.04px;" width="150.04"/>
            ...
            <div style="font-size: 16px; line-height: 140%; text-align: left; word-wrap: break-word;">
                <p style="line-height: 140%;"><strong><span style="color: #4c4b63; white-space: normal; background-color: #f7f7ff; float: none; display: inline; line-height: 19.6px;">Hey ${options.name},</span></strong><br style="box-sizing: border-box; outline-style: none; color: #4c4b63; white-space: normal;" /><br style="box-sizing: border-box; outline-style: none; color: #4c4b63; white-space: normal;" /><span style="color: #4c4b63; white-space: normal; background-color: #f7f7ff; float: none; display: inline; line-height: 19.6px;">Thank you for joining Messenger! To activate your account and start exploring, please click the verification link below o copy the Activation Code.</span></p>
            </div>
            ...
            <div style="font-size: 30px; line-height: 140%; text-align: center; word-wrap: break-word;">
                <p style="line-height: 140%;"><span style="color: #3598db; line-height: 42px;"><strong>${options.code}</strong></span></p>
            </div>
